  ...
  function Coluna({ lista }) {
    return (
      <div>
        ...
        {/* Itens */}
        {lista.map((cidade) => {
          const numero = "5571983149876";
          const mensagem = `Olá, gostaria de fazer uma cotação para a cidade de ${cidade.nome}`;
          ...
          return (
            ...
            >
              ...
              <a
                ...
                title="Clique para fazer uma cotação"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                title="Pressione para fazer uma cotação"
